    ...
    >
      ...
      >
        <div className="flex flex-col space-y-1.5 p-6">
          ...
          <p className="text-sm text-gray-400">
            ...
            langue de destination. Transformez vos mots dans la langue de votre
      ...
      >
        <div className="flex flex-col space-y-1.5 p-6">
          ...
          <p className="text-sm text-gray-400">
            Explorez une nouvelle dimension de la traduction avec notre fonction
            d'importation de fichiers PDF. Cliquez sur 'Choisir un Fichier' pour
      ...
      >
        <div className="flex flex-col space-y-1.5 p-6">
          ...
          <p className="text-sm text-gray-400">
            Mission accomplie ! Téléchargez votre fichier PDF traduit en un clin
            d'œil. Prêt à partager vos idées à travers les langues ? C'est
            simple et efficace.
          </p>
        </div>
      </div>
